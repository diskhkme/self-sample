...
--pc data/00000008_low.xyz \
--init-var 0.15 \
--D1 400 --D2 400 \
--save-path demo-results/00000008_low \
...
--lr 0.001 --name 00000008_low_result \
--iterations 25 \
--export-interval 100 \
...
--D1 400 --D2 400 \
--save-path demo-results/00000008_low \
--generator demo-results/00000008_low/generators/model5000.pt \
--sampling-mode curvature \
--p1 0.8 --p2 0.2 \
--batch-size 2 \
--k 8 \
